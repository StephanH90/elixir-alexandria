defmodule Alexandria.Core.Resource.DocumentMark.Transformer do
  @moduledoc false
  use Spark.Dsl.Transformer
  import Spark.Dsl.Builder

  alias Alexandria.Core.Resource.DocumentMark.Info
  ...
  def transform(dsl) do
    ...
    |> Ash.Resource.Builder.add_new_relationship(
      :belongs_to,
      :document,
      Info.alexandria_document_mark_document_resource!(dsl),
      allow_nil?: false,
      public?: true
    )
    |> Ash.Resource.Builder.add_new_relationship(
      :belongs_to,
      :mark,
      Info.alexandria_document_mark_mark_resource!(dsl),
